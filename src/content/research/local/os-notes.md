---
title: "OS Notes — Field Notes"
description: "# ch4: - bộ nhớ - chương trình lưu ở đâu, lưu thế nào, các loại bộ nhớ (6 lớp từ nhanh đến chậm) - bộ nhớ khác nhau ở kích thước và tốc độ truy cập - các bước compile chương trình - nạp chương trình ở bất cứ…"
...
wordCount: 2258
featured: false
sourcePath: "content/research/OS notes.md"
---
...
- # ch4: - bộ nhớ
	...
	- # Phân đoạn
			- ==SCB==
			- ![](/Personal_Site/media/research/os-notes/Pasted%20image%2020260117085755.png)
			- ![](/Personal_Site/media/research/os-notes/Pasted%20image%2020260117090551.png)
			- ưu:
				- sơ đồ tự động
				- ==dễ dàng bảo vệ đoạn
			...
			- ==sector đầu tiên là MBR (trong gpt thì chỉ tồn tại để backward compat)
				...
				- bảng phân chương(64 bytes)
					...
					- ==mỗi phần tử chứa thông tin một vùng
						...
						- ![](/Personal_Site/media/research/os-notes/Pasted%20image%2020260118065420.png)
				...
				- hệ thống file
					...
					- ntfs
					- ext3 ![](/Personal_Site/media/research/os-notes/Pasted%20image%2020260118081428.png)
