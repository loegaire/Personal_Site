...
description: "Let's start analyzing the source: python def main(token): key = bytes.fromhex(randomstring)"
...
kind: "writeup"
status: "solved"
tags: ["Reverse Engineering", "picoCTF 2025", "Writeup"]
readingTime: 2
wordCount: 247
featured: false
sourcePath: "~/ctf/writeups/(picoCTF 2025) Writeups.md"
---
...
![alt text](/Personal_Site/media/missing-attachment.svg)
